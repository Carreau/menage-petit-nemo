...
export const STRINGS = {
  fr: {
    ...
    tab_danger: "Saison",
    logs_help:
      "Historique des inscriptions, désinscriptions et modifications admin, plus récentes en tête.",
    logs_empty: "Aucune activité enregistrée pour l'instant.",
    logs_col_when: "Date",
    logs_col_actor: "Par",
    logs_col_action: "Action",
    logs_col_family: "Famille",
    logs_col_saturday: "Samedi",
    logs_col_details: "Détails",
    logs_slot: "Place",
    logs_actor_family: "Famille",
    logs_actor_admin: "Admin",
    logs_action_claim: "Inscription",
    logs_action_release: "Désinscription",
    logs_action_family_create: "Famille créée",
    logs_action_family_update: "Famille modifiée",
    logs_action_family_delete: "Famille supprimée",
    logs_action_families_import: "Import familles",
    logs_action_saturday_generate: "Samedis générés",
    logs_action_saturday_update: "Samedi modifié",
    logs_action_saturday_delete: "Samedi supprimé",
    logs_action_reset_assignments: "Réinitialisation des affectations",
    logs_action_clear_saturdays: "Effacement des samedis",
  ...
  en: {
    ...
    tab_danger: "Season",
    logs_help:
      "History of sign-ups, releases and admin changes, newest first.",
    logs_empty: "No activity recorded yet.",
    logs_col_when: "When",
    logs_col_actor: "By",
    logs_col_action: "Action",
    logs_col_family: "Family",
    logs_col_saturday: "Saturday",
    logs_col_details: "Details",
    logs_slot: "Slot",
    logs_actor_family: "Family",
    logs_actor_admin: "Admin",
    logs_action_claim: "Claimed",
    logs_action_release: "Released",
    logs_action_family_create: "Family created",
    logs_action_family_update: "Family updated",
    logs_action_family_delete: "Family deleted",
    logs_action_families_import: "Families imported",
    logs_action_saturday_generate: "Saturdays generated",
    logs_action_saturday_update: "Saturday updated",
    logs_action_saturday_delete: "Saturday deleted",
    logs_action_reset_assignments: "Assignments reset",
    logs_action_clear_saturdays: "Saturdays cleared",
